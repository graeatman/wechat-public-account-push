export const USER_CONFIG = {
  ...
  USERS: [Tau09_17-z]
    {
      ...
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "P1qo9nEfhTxAMILijg21_B5na_PvAQUYMWJ_ll80_iU",
      // 所在省份
      province: "河南",
      // 所在城市
      city: "郑州",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "宝贝", "year": "2004", "date": "03-06"},
        {"type": "节日", "name": "恋爱纪念日", "year": "2022", "date": "06-10"},
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {"type": "生日", "name": "宝贝", "year": "2004", "date": "04-24"},
        {"type": "节日", "name": "恋爱纪念日", "year": "2022", "date": "06-10"},
      ],
      // 专属纪念日/倒数日，如果你在这里填写了纪念日/倒数日，就不会计算CUSTOMIZED_DATE_LIST的日子了, 和CUSTOMIZED_DATE_LIST的配置方法相同，可以往下查看，我这里就不重复写了
      customizedDateList: [纪念日/倒数日]
        // 在一起的日子
  ...
  CALLBACK_TEMPLATE_ID: "P1qo9nEfhTxAMILijg21_B5na_PvAQUYMWJ_ll80_iU",
  
  // 接收成功回调消息的微信号，（一般来说只填自己的微信号, name填不填无所谓）
  CALLBACK_USERS: [bebebe0_0consistent]
    {
      // 一般都填自己
      name: "自己",
